...
#include "lib\jpeg-8\jinclude.h"
#include "lib\jpeg-8\jpeglib.h"
#include "lib\jpeg-8\jerror.h"		
...
// return 0 on error
int bmp2jpegtomemory(PBYTE buf, int quality, BYTE ** buf_jpeg, DWORD * buf_jpeg_size);
